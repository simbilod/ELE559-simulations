...
Extended to include P-doping layers and vias to Si
"""
...
def define_param(name, type, description, default=None, layertype=None, zmin=None, zmax=None, dopinglevel=None, **kwargs):
...
class EBeamLayersMixin(PCell):
    ...
    params = ParamContainer(
        define_param("silayer", TypeLayer, "Si (1/0)", default=TECHLAYERS["Si"], layertype='Si', zmin=0, zmax=0.22),
        define_param("sislab", TypeLayer, "Si slab (2/0)", default=TECHLAYERS["Si slab"], layertype='Si', zmin=0, zmax=0.09),
        define_param(
            "31_Si_p6nm",
            TypeLayer,
            "'31_Si_p6nm' (31/0)",
        ...
        define_param("si_n", TypeLayer, "'Si N' (20/0)", default=TECHLAYERS["Si N"], layertype='doping', dopinglevel=-5E17),
        define_param("si_npp", TypeLayer, "'Si N++' (24/0)", default=TECHLAYERS["Si N++"], layertype='doping', dopinglevel=-1E20),
        define_param("si_p", TypeLayer, "'Si P' (22/0)", default=TECHLAYERS["Si P"], layertype='doping', dopinglevel=5E17),
        define_param("si_ppp", TypeLayer, "'Si P++' (26/0)", default=TECHLAYERS["Si P++"], layertype='doping', dopinglevel=1E20),
        ...
        define_param("VC", TypeLayer, "VC (40/0)", default=TECHLAYERS["VC"], layertype='contact'),
        define_param(
